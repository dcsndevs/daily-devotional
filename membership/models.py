...
RELATIONSHIP = ((0, "Choose not to say"), (1, "Yes"), (2, "No"),
                (3, "Not sure"), (4, "Married"))


class Profile(models.Model):
    """
    Stores a single profile post entry related to :model:`auth.User`.
    """
    ...
    favourite_scripture = models.CharField(max_length=500, null=True,
                                           blank=True)
    favourite_bible_character = models.CharField(max_length=50, null=True,
                                                 blank=True)
